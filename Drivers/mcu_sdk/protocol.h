...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "rilqguscpxtnls0i"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//状态1(可下发可上报)
//备注:
#define DPID_CONDITION_1 101
//状态2(可下发可上报)
//备注:
#define DPID_CONDITION_2 102
//状态3(可下发可上报)
//备注:
#define DPID_CONDITION_3 103
//状态4(可下发可上报)
//备注:
#define DPID_CONDITION4 104
//状态5(可下发可上报)
//备注:
#define DPID_CONDITION_5 105
//状态6(可下发可上报)
//备注:
#define DPID_CONDITION_6 106
//状态7(可下发可上报)
//备注:
#define DPID_CONDITION_7 107
//状态8(可下发可上报)
//备注:
#define DPID_CONDITION_8 108
//状态9(只上报)
//备注:
#define DPID_CONDITION_9 109
